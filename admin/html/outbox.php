...
$sql = "SELECT COUNT(id) FROM email WHERE schoolidentity = '$school_name' AND sender = '$admin'";
$query = mysqli_query($conn,$sql);
...
$sql = "SELECT * FROM email WHERE schoolidentity = '$school_name' AND sender = '$admin' ORDER BY id DESC";	
$query = mysqli_query($conn, $sql);
